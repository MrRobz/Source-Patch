...
export const SearchResult = ({ searchResult, onEditFile }: Props): ReactElement => {
  return (
    <div className="flex w-full flex-col rounded border shadow">
      <div className="h-10 w-full max-w-full overflow-x-auto overflow-y-hidden whitespace-nowrap rounded-t bg-neutral-100 px-4 py-3 font-medium text-neutral-800">
        {searchResult.path}
      </div>
